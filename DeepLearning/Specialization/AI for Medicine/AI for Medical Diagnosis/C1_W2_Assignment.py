...
def get_accuracy(y, pred, th=0.5):
    ...
    TP =  true_positives(y=y, pred=pred, th=th)
    FP = false_positives(y=y, pred=pred, th=th)
    TN =  true_negatives(y=y, pred=pred, th=th)
    FN = false_negatives(y=y, pred=pred, th=th)
